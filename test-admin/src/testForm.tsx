...
import { TextInput, DateInput, TimeInput, required, SelectInput, BooleanInput, SimpleForm, NumberInput, Create, Datagrid, ArrayInput, SimpleFormIterator, SelectArrayInput }
    from 'react-admin';
            ...
            <SimpleForm>
                ...
                <Accordion defaultExpanded={true}>
                    ...
                    <AccordionDetails>
                        ...
                        <BooleanInput label="Ginecobstetricia" source="ginecobstetricia" value={ginecobstetricia} onChange={e => setGinecobstetricia(e.target.checked)} />
                        <BooleanInput label="Traumatismo" source="traumatismo" value={traumatismo} onChange={e => setTraumatismo(e.target.checked)} />
                        <BooleanInput label="Enfermedad" source="enfermedad" value={enfermedad} onChange={e => setEnfermedad(e.target.checked)} />
                        {/*IV. Parto*/}
                        {ginecobstetricia && (
                            <Accordion>
                                <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                ...
                <Accordion>
                    ...
                    <AccordionDetails>
                        ...
                        {/* Vehículos involucrados dinámicos */}
